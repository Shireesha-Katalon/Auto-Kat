...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'medical checkup')
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_01042025'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_01042025'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_medical checkup'))
